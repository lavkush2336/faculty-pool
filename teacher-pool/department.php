<?php
// departments.php (final)
// Displays only top-level departments dynamically (no branches)
...
$stmt = $pdo->prepare("
    SELECT id, name, slug, dept_type, icon_class, page_link, description 
    FROM departments 
    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex justify-between items-center py-3">
        ...
        <div class="flex space-x-4 ml-12">
          <a href="user-login.html" class="nav-item">
            <i class="fas fa-user-graduate me-2"></i>User Login
          </a>
          <a href="faculty-login.html" class="nav-item">
  ...
  <section class="main-content py-8">
    <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="dept-card" data-aos="zoom-in" data-aos-delay="100">
              ...
              <div class="dept-main">
                ...
                <?php if (!empty($dept['description'])): ?>
                  <p class="dept-desc text-sm text-slate-500 mt-2"><?php echo e($dept['description']); ?></p>
                <?php endif; ?>
              </div>
            </div>
          <?php endforeach; ?>
      ...
      <div class="mt-8 flex gap-4 items-center">
        <a href="index.html" class="creative-button" data-aos="fade-up">
