<?php
// forgot-password-email.php (Step 1: Email Input)
session_start();
...
// 2. DEFINE YOUR EMAIL FUNCTION (Duplicated to make this file independent)
...
$error_message = '';
// Check if redirected from reset page due to expired OTP
  ...
  <div class="forgot-container">
    <div class="forgot-card">
      ...
      <div id="emailSection">
        ...
        <form id="emailForm" method="post" action="forgot-password-email.php">
