...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($facultyEmail && $password) {
        try {
            ...
            // FIX: We now fetch 'password1' (the hash) from the new column.
            $stmt = $pdo->prepare("SELECT faculty_id, first_name, password1 FROM faculty WHERE email = :email");
            ...
            if ($faculty) {
                ...
                // FIX: Verify against the 'password1' column value.
                if (password_verify($password, $faculty['password1'])) {
                    ...
                    // Redirect to the faculty-projects page
                    // 🔥 MODIFICATION HERE: Changed from teacher-project.php to faculty-projects.php
                    header('Location: faculty-projects.php'); 
                    exit;
                }
            }
...
<head>
  ...
  <style>
    ...
    /* NEW STYLE: Text Gradient for Heading and Icon */
    .faculty-title-gradient {
        background: linear-gradient(135deg, #8B0000 0%, #A52A2A 100%);
        ...
        <div class="col-12 col-md-6 col-lg-4 mx-auto">
          <div class="login-card p-5" data-aos="zoom-in" data-aos-duration="800">
            <div class="text-center mb-4">
              <div class="text-4xl faculty-title-gradient mb-3">
                <i class="fas fa-user-tie"></i>
              </div>
              <h2 class="h3 fw-bold faculty-title-gradient mb-2">Faculty Login</h2>
